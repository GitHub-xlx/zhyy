...
layui.use(['table', 'jquery','form'], function () {
	...
	table.render({
		elem: '#demo'//指定表格
		, id: 'idTest'
		, url: 'drugController/pharmacyLowLimitDrugs'//指定对应servlet
		...
		, cols: [[
			...
			, {field: 'drugminimums', width: 150, title: '药品最低限量', sort: true}		, {field: 'drugunit', width: 130, title: '药品单位', sort: true}
	...
	$("#query_bt").click(function () {
		table.reload('idTest', {
			url: "drugController/pharmacyDrugsQuery"
			, where: { //设定异步数据接口的额外参数，任意设
				drugcode:$('#drugcode').val(),
				commoname: $('#commoname').val(),
			}
